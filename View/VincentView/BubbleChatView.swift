...
struct BubbleChatView: View {
    ...
    var body: some View {
        VStack{
            ...
            Text(text)
                .font(.system(size: (UIDevice.current.userInterfaceIdiom != .pad ? 16 : 24), weight: .medium))
                .multilineTextAlignment(.center)
                .padding(.vertical, (UIDevice.current.userInterfaceIdiom != .pad ? 12 : 24))
                    .padding(.horizontal, (UIDevice.current.userInterfaceIdiom != .pad ? 16 : 32))
